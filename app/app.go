...
import (
	...
	nftkeeper "github.com/ShareRing/nft-module/x/nft/keeper"
	nfttypes "github.com/ShareRing/nft-module/x/nft/types"
)

const appName = "block"

var (
	DefaultCLIHome  = os.ExpandEnv("$HOME/.blockcli")
	DefaultNodeHome = os.ExpandEnv("$HOME/.blockd")
...
func NewInitApp(
	...
	app.subspaces[nfttypes.ModuleName] = app.paramsKeeper.Subspace(nfttypes.DefaultParamspace)
