...
var (
	...
	NewQueryNFTsByDigitalHashParams = types.NewQueryNFTsByDigitalHashParams
	...
	URIsKeyPrefix            = types.URIsKeyPrefix
	DigitalHashesKeyPrefix   = types.DigitalHashesKeyPrefix
)
...
type (
	...
	MsgEditNFTDigitalHash = types.MsgEditNFTDigitalHash
